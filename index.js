...
app.all(/api\/dump/, (req, res) => {
    if (req.path.endsWith('/@original')) {
        return Util.SendResponse(res, 200, {id: Util.GenerateSnowflake()});
    }
...
app.post('/api/github', (req, res) => {
    ...
    if (body.action == 'completed') {
        if (body.check_run && body.check_run.conclusion == 'success') {
            ...
            exec('git update-index --assume-unchanged package-lock.json && git pull', {cwd: path}, error => {
